...
<div class="col-12 p-3">
	<div class="col-12 col-lg-12 p-0 ">
		...
		<form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.services.store')}}">
		@csrf
		...
		<div class="col-12 col-lg-8 p-0 main-box">
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
					<input type="text" name="slug"   maxlength="190" class="form-control" value="{{old('slug')}}" >
				</div>
			</div>
			<div class="col-12 col-lg-6 p-2">
				<div class="col-12">
