                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="DarkModeInput"
                                           name="dashboard_dark_mode"
                                           {{$settings->dashboard_dark_mode==1?"checked":""}} value="1">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 row p-0 taber" id="statistics-tab">
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                                المشاريع
                            </div>
                            <div class="col-12 col-lg-9 px-2">
                                <input type="number" name="num_of_projects" class="form-control" value="{{$settings->num_of_projects}}"
                                       maxlength="190">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="number" name="num_of_customers" class="form-control" value="{{$settings->num_of_customers}}"
                                       maxlength="190">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="number" name="num_of_companies" class="form-control" value="{{$settings->num_of_companies}}"
                                       maxlength="190">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="number" name="num_of_clients" class="form-control" value="{{$settings->num_of_clients}}"
                                       maxlength="190">
                            </div>
                        </div>
                        ...
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="number" name="num_of_employees" class="form-control" value="{{$settings->num_of_employees}}"
                                       maxlength="190">
                            </div>
                        </div>
