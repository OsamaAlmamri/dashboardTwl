        ...
        <div id="accordion-1" class="accordion-wrapper">
          ...
          <div class="card accordion-item col-lg-12">
            <div class="card-header" id="accordion-heading-{{$faq->id}}">
              <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-{{$faq->id}}" aria-expanded="false" aria-controls="accordion-collapse-{{$faq->id}}" style="text-align: start; color: #f7ad42">{{$faq->question}}</button>
            </div>
            <!-- /.card-header -->
